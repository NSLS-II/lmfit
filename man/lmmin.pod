...
B<void lmmin( int> I<n_par>B<, double *>I<par>B<, int *>I<userderive>B<,
            int> I<m_dat>B<, constS< >void *>I<data>B<,
            void *>I<evaluate>B<(
                 constS< >double *>I<par>B<, int >I<m_dat>B<, constS< >void *>I<data>B<,
                 double *>I<fvec>B<, int *>I<userderive>B<, double *>I<fjac>B<,
                 int *>I<userbreak>B<),
...
Number of free variables. Length of parameter vector I<par>.

=item I<par>

Parameter vector, of length I<n_par>. On input, it must contain a reasonable guess; on output, it contains the solution found to minimize ||I<fvec>||.

=item I<userderive>

Integer vector of length I<n_par>, can be used to indicate whether I<evaluate> shall or shall not compute derivatives with respect to individual parameters. 

=item I<m_dat>

Number of scalar functions to be minimized. Length of vector I<fvec>.
...
Progress messages will be written to this file. Typically I<stdout> or I<stderr>. The value I<NULL> will be interpreted as I<stdout>.
...
Set when termination has been forded by the user supplied routine I<evaluate>.
