...
B<typedef void (*>I<lm_eval_ftyp>)B<(
            constS< >double *>I<par>B<, int >I<m_dat>B<,
            constS< >void *>I<data>B<, double *>I<fvec>B<, int *>I<info>B< );

B<typedef void (*>I<lm_prin_ftyp>)B<(
...
B<void lmmin( int> I<n_par>B<, double *>I<par>B<, int> I<m_dat>B<, constS< >void *>I<data>B<,
            lm_eval_ftyp >I<evaluate>B<,
            lm_prin_ftyp >I<printout>B<,
...
is written to stdout. Which output, is not yet fixed. Try bit values 1 and 2.
