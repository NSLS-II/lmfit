...
B<lmfit> is a C library for Levenberg-Marquardt least-squares minimization and curve fitting. It is very mature code, based on decades-old algorithms from the FORTRAN library MINPACK.
...
For an example how to use B<lmmin>, see the source files I<lmcurve.h> and <lmcurve.c>. Do not patch these files; copy and modify them to create your own, differently named version of I<lmcurve_data_struct>, I<lmcurve_evaluate>, and I<lmcurve>.
=head1 COPYING
