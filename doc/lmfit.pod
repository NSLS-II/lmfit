...
B<void lmmin( int> I<n_par>B<, double> I<*par>B<, int> I<m_dat>B<, void> I<*data>B<,
...
B<void (*>I<evaluate>B<)( double> I<*par>B<, int> I<m_dat>B<, void> I<*data>B<,
                  double> I<*fvec>B<, int> I<*info>B< );>

B<void (*>I<printout>B<)( int> I<n_par>B<, double> I<*par>B<, int> I<m_dat>B<,
                  void> I<*data>B<, double> I<*fvec>B<,
...
Generic minimization and one-dimensional curve fitting have been separated more clearly, and the interface for the latter has been greatly simplified (see F<lmcurve.h> and F<demo/curve1.c>). Furthermore, control (input) and monitoring (output) parameters are now stored in two different records. For better readability of the code, even the innermost function declarations of I<evaluate> and I<printout> have been changed.
