...
I<control>: a record holding control (input) parameters,
...
I<lm_control_float> and I<lm_control_double>.

I<status>: a record holding monitoring (output) variables,
describing progress or result of the minimization.
