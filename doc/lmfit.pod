...
(for I<fvec> calculated to single or double precision) are provided by

B<extern const lm_control_type> I<lm_control_float>B<;>

B<extern const lm_control_type> I<lm_control_double>B<;>
...
The initialization routine B<lm_initialize_control(...)> has been eliminated, replacement being provided by the constant record I<lm_control_double>. Either pass I<&lm_control_double> directly to B<lm_minimize>, or copy its values, declaring and initializing B<lm_control_type> I<control> B<=> I<lm_control_double>B<;>

Generic minimization and one-dimensional curve fitting have been separeted more clearly, introducing a new declaration file I<lmcurve.h>. The old implementation file I<lm_eval.c> has been renamed I<lmfit.c>. The routines for one-dimensional curve fitting, I<lm_evaluate_default>, I<lm_printout_default>, I<lm_data_type_default> have been renamed into I<lmfit_evaluate>, I<lmfit_printout>, I<lmfit_data_type>.
